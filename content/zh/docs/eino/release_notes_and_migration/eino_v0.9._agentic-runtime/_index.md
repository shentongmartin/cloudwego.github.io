...
- [Eino: 快速开始](/zh/docs/eino/quick_start)：整个系列基于 AgenticMessage 重写。
...
- [Eino ADK: Agent Cancel 与 TurnLoop 快速入门](/zh/docs/eino/core_modules/eino_adk/eino_adk_agent_cancel_and_turnloop_quickstart)
...
- [ChatModel Failover 功能文档](/zh/docs/eino/core_modules/eino_adk/agent_implementation/chat_model/chatmodel_failover_guide)
...
- [Eino ADK: ChatModelAgentMiddleware](/zh/docs/eino/core_modules/eino_adk/eino_adk_chatmodelagentmiddleware)
...
> 💡
> 当前（5.19）最新版本为 v0.9.0-beta.1，预计一周后发布正式版。在正式版发布前，请始终使用最新的 beta 版本；正式版发布后，请升级到最新的正式版本。
...
查看最新版本号：[github.com/cloudwego/eino/tags](https://github.com/cloudwego/eino/tags)
